                        ...
                        <div className="table-responsive p-3">
                            <table className="table table-sm">
                                ...
                                <tr>
                                    ...
                                    <td>Pangeran Diponegoro Arrest</td>
                                    <td><img src="../../../public/img/img_order_monitoring/pict1.png" style={{width: "200px"}}/></td>
                                    <td>Rp. 90.000</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>Jeremy Limanto</td>
                                    <td>Pangeran Diponegoro Arrest</td>
                                    <td><img src="../../../public/img/img_order_monitoring/pict2.png" style={{width: "200px"}}/></td>
                                    <td>Rp. 90.000</td>
                                    <td>
                                    <span className="badge text-bg-secondary">Pop Art</span>
                                    <span className="badge text-bg-secondary">Pixel Art</span>
                                ...
                                <tr>
                                    ...
                                    <td>Jeremy Limanto</td>
                                    <td>Pangeran Diponegoro Arrest</td>
                                    <td><img src="../../../public/img/img_order_monitoring/pict3.png" style={{width: "200px"}}/></td>
                                    <td>Rp. 90.000</td>
                                    <td>
                                    <span className="badge text-bg-secondary">Pop Art</span>
                                    <span className="badge text-bg-secondary">Pixel Art</span>
